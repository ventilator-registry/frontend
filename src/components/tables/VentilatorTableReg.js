...
export default function EnhancedTable(props) {
    ...
    function createData(name, brand, model, quantity) {
        return { name, brand, model, quantity };
    }
    
    const rows = props.vents.map(vents => {
        return createData(`${vents.name}`, `${vents.brand}`, `${vents.model}`, `${vents.quantity}`)
    })
